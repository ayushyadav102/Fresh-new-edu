...
// Also replace undefined super admin variables with empty array if not defined.
content = content.replace(/INITIAL_SCHOOL_TENANTS/g, '[]');
content = content.replace(/INITIAL_GLOBAL_USERS/g, '[]');
content = content.replace(/INITIAL_PLATFORM_METRICS/g, '[]');
content = content.replace(/INITIAL_BILLING_INVOICES/g, '[]');
content = content.replace(/INITIAL_SUPPORT_TICKETS/g, '[]');
